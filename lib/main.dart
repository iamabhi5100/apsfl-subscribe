...
import 'package:apsflsubscribes/screens/splashscreen.dart';
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      theme: ThemeData(
        ...
        // the application has a purple toolbar. Then, without quit ting the app,
        ...
        colorScheme: ColorScheme.fromSeed(
            seedColor: const Color.fromARGB(255, 129, 81, 177)),
        useMaterial3: true,
      ),
